  ...
  return (
    <div className='w-full'>
      ...
      <input
        ...
        } px-4 py-3 rounded-lg focus:outline-none focus:border-pacman-yellow focus:ring-2 focus:ring-pacman-yellow transition-all duration-200 font-family-vt323 text-2xl w-full ${className}`}
        {...props}
      />
      {error && (
